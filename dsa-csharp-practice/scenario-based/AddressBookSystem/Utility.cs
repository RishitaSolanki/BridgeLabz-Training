...
namespace ScenarioBased.AddressBookSystem
{
        public class Utility
        {
            ...
            {
                Console.Title = $"Address Book System | Version {Version} | Rishita";
            ...
            public static EContact CreateContactWithUI()
            {
                PrintLogo();
                Console.ForegroundColor = ColorSecondary;
                ...
                Console.ResetColor();
                return new EContact(fName, lName, addr, city, state, zip, phone, email);
            }
            ...
            public static EContact GetUpdatedContactDetails(EContact existing)
            {
                PrintLogo();
                Console.ForegroundColor = ColorSecondary;
            ...
            public static void PrintSearchResults(EContact[] results)
            {
                PrintLogo();
            ...
            public static void PrintSingleResult(EContact c)
            {
                PrintLogo();
